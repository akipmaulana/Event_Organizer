<% 
    ...
    model.User user= model.User.class.cast(session.getAttribute("user"));
    int id_user = Integer.parseInt(user.getRs().getString("id_user"));
    user.viewDataUser(id_user);
